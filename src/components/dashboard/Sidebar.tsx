...
import {
  ...
  Globe, CalendarDays, CheckSquare
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { href: "/dashboard/tasks",      label: "المهام",        icon: <FileText         className="w-[18px] h-[18px]" />, roles: ["MANAGER","LAWYER","LEGAL_SECRETARY","CONTENT_MANAGER"] },
