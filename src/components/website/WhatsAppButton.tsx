  ...
  return (
    <div className="fixed left-0 bottom-32 z-50 flex flex-col gap-3 items-start">
      ...
      >
        ...
        <span className="text-xs font-bold font-arabic whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">اتصل بنا</span>
      </a>
      ...
      >
        ...
        <span className="text-xs font-bold font-arabic whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">واتساب</span>
      </a>
      ...
      >
        ...
        <span className="text-xs font-bold font-arabic whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">راسلنا</span>
      </a>
