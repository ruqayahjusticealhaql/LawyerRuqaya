  ...
  return (
    <div className="fixed left-4 bottom-24 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        aria-label="واتساب"
        className="w-12 h-12 bg-white hover:bg-green-500 text-green-500 hover:text-white rounded-2xl shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110"
      >
